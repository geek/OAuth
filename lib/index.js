...
exports.AuthServer.prototype.authorizeRequest = function (req, userId, callback) {
    var self = this,
...
exports.AuthServer.prototype.getDeviceCode = function (req, callback) {
    var self = this,
        context = contextHandler(req);
...
exports.AuthServer.prototype.getTokenData = function (context, userId, callback) {
    var self = this,
...
exports.AuthServer.prototype.grantAccessToken = function (req, userId, callback) {
    var self = this,
        context = contextHandler(req);
...
exports.AuthServer.prototype.validateAccessToken = function (req, callback) {
    var self = this,
        context = contextHandler(req);
